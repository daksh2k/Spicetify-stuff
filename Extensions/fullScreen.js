...
<div id="fsd-foreground">
    ...
    button.id = "fs-button";
    button.setAttribute("title", translations[LOCALE].settings.fullscreenBtnDesc);
    ...
    button2.setAttribute("title", translations[LOCALE].settings.tvBtnDesc);
